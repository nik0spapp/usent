...
======================
The attached code is an implementation of an unsupervised sentiment classification procedure (for English text) that was used originally for an opinion mining
